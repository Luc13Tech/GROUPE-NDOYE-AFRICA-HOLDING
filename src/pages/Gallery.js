...
const GALLERY_ITEMS = [
  ...
  { id:16, cat:'plans',    src:'/Images/yaye-dia/villa-f3-plan2.jpg',      fallback:'https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?w=800&q=85', fr:'Plan 3D F3 — Intérieur détaillé',            en:'F3 3D Plan — Detailed interior',              es:'Plan 3D F3 — Interior detallado',            de:'F3 3D Plan — Detailliertes Innere' },
  { id:17, cat:'plans',    src:'/Images/yaye-dia/villa-f4pp-plan.jpg',     fallback:'https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?w=800&q=85', fr:'Plan 3D F4 Plein Pied — Composition',        en:'F4 Single-Story 3D Plan — Layout',            es:'Plan 3D F4 Planta Baja — Composición',        de:'F4 Einstöckig 3D Plan — Grundriss' },
  ...
  { id:20, cat:'plans',    src:'/Images/yaye-dia/villa-f4duplex-plan.jpg', fallback:'https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?w=800&q=85', fr:'Plan 3D F4 Duplex — RDC + Étage',           en:'F4 Duplex 3D Plan — Ground + Upper floor',    es:'Plan 3D F4 Dúplex — PB + Planta alta',       de:'F4 Duplex 3D Plan — EG + OG' },
