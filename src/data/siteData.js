...
export const PARTNERS_WORLD = [
  ...
  {code:'IN',fr:{country:'Inde',focus:"Transport logistique (camions) — Flotte de poids lourds, transport intermodal et solutions logistiques pour l'Afrique et l'Asie."},en:{country:'India',focus:"Logistics transport (trucks) — Heavy goods fleet, intermodal transport and logistics solutions for Africa and Asia."},es:{country:'India',focus:"Transporte logístico (camiones) — Flota de vehículos pesados, transporte intermodal y soluciones logísticas para África y Asia."},de:{country:'Indien',focus:"Logistiktransport (LKW) — Schwerlastflotte, intermodaler Transport und Logistiklösungen für Afrika und Asien."}},
