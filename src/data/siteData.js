...
export const VILLA_TYPES = [
  ...
  { id:'f4pp', color:'#34d399', surface:'225 m²', bati:'106 m²',
    img:'/Images/yaye-dia/villa-f4pp-facade.jpg', planImg:'/Images/yaye-dia/villa-f4pp-plan2.jpg',
  ...
  { id:'f4duplex', color:'#6366f1', surface:'225 m²', bati:'232 m²',
    img:'/Images/yaye-dia/villa-f4duplex.jpg', planImg:'/Images/yaye-dia/villa-f4duplex-nuit.jpg',
  ...
  { id:'f5', color:'#f472b6', surface:'225 m²', bati:'340 m²',
    img:'/Images/yaye-dia/villa-f5-terrasse.jpg', planImg:'/Images/yaye-dia/villa-f5-terrasse-plan.jpg',
...
export const YAYE_SLIDES = [
  { img:'/Images/yaye-dia/villa-f5-facade3.jpg',
...
export const COMPANIES = [
  ...
  },
  {
    ...
    desc: {
      ...
      de: "AzaRatti 1 of 1 ist eine afrikanische Luxusmodemarke, spezialisiert auf ultrastreng limitierte Jacken. Jedes Stück ist einzigartig und handgefertigt.",
      zh: "AzaRatti 1 of 1是非洲奢侈时尚品牌，专注于超限量版夹克和服装。每件作品都是独一无二的手工艺品。",
    },
  },
  {
    id: 3, active: true,
    ...
    desc: {
      ...
      en: "AzaRatti specialises in the sale and distribution of the finest quality natural rice. An authentic product, carefully cultivated and selected to the highest nutritional standards.",
      es: "AzaRatti está especializada en la venta y distribución de arroz natural de la mejor calidad para los mercados africanos e internacionales.",
      de: "AzaRatti ist auf den Verkauf und Vertrieb von Natureis höchster Qualität spezialisiert. Ein authentisches Produkt nach höchsten Ernährungsstandards.",
      zh: "AzaRatti专注于销售和分销最优质的天然大米。经过精心种植，按照最高营养标准精选。",
    },
  },
];
