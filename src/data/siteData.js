...
export const COMPANIES = [
  {
    ...
    country: 'Sénégal',
    website: 'https://www.terratransport-sa.com',
    desc: {
      fr: "Terratransport & Industrie Mobile est spécialisée dans la commercialisation de poids lourds et la gestion de flottes de camions. Solutions de transport intermodal et logistique pour l'Afrique et l'Asie.",
      en: "Terratransport & Industrie Mobile specialises in heavy truck commercialisation and fleet management. Intermodal transport and logistics solutions for Africa and Asia.",
      es: "Terratransport & Industrie Mobile está especializada en la comercialización de camiones pesados y la gestión de flotas. Soluciones de transporte intermodal para África y Asia.",
      de: "Terratransport & Industrie Mobile ist auf die Vermarktung von Schwerlastfahrzeugen und Flottenmanagement spezialisiert. Intermodale Transport- und Logistiklösungen für Afrika und Asien.",
      zh: "Terratransport & Industrie Mobile专门从事重型卡车销售和车队管理。为非洲和亚洲提供多式联运和物流解决方案。",
    },
  },
  {
    id: 2, active: true,
    name: 'AzaRatti 1 of 1',
    logo: '/Images/entreprises/logo-azaratti1of1.png',
    sector: { fr:'Mode & Luxe', en:'Fashion & Luxury', es:'Moda y Lujo', de:'Mode & Luxus', zh:'时尚与奢侈品' },
    country: 'Sénégal',
    website: 'https://www.azaratti1of1.com',
    desc: {
      fr: "AzaRatti 1 of 1 est une marque de mode africaine de luxe spécialisée dans la création de vestes et pièces vestimentaires en édition ultra-limitée. Chaque pièce est unique, artisanale et incarne l'excellence africaine contemporaine.",
      en: "AzaRatti 1 of 1 is an African luxury fashion brand specialising in ultra-limited edition jackets and clothing pieces. Each piece is unique, handcrafted and embodies contemporary African excellence.",
      es: "AzaRatti 1 of 1 es una marca de moda de lujo africana especializada en chaquetas y prendas de edición ultra-limitada. Cada pieza es única, artesanal y encarna la excelencia africana contemporánea.",
      de: "AzaRatti 1 of 1 ist eine afrikanische Luxusmodemarke, die sich auf ultrastreng limitierte Jacken und Kleidungsstücke spezialisiert hat. Jedes Stück ist einzigartig, handgefertigt und verkörpert zeitgenössische afrikanische Exzellenz.",
      zh: "AzaRatti 1 of 1是一个非洲奢侈时尚品牌，专注于超限量版夹克和服装的创作。每件作品都是独一无二的手工艺品，体现了当代非洲的卓越精神。",
    },
  },
  {
    id: 3, active: true,
    name: 'AzaRatti',
    logo: '/Images/entreprises/logo-azaratti.png',
    sector: { fr:'Agroalimentaire & Commerce', en:'Agri-Food & Trade', es:'Agroalimentario y Comercio', de:'Lebensmittel & Handel', zh:'农产品与贸易' },
    country: 'Sénégal',
    website: 'https://www.azaratti.com',
    desc: {
      fr: "AzaRatti est spécialisée dans la vente et la distribution de riz naturel de la meilleure qualité. Un produit authentique, cultivé avec soin et sélectionné selon les plus hauts standards nutritionnels pour les marchés africains et internationaux.",
      en: "AzaRatti specialises in the sale and distribution of the finest quality natural rice. An authentic product, carefully cultivated and selected according to the highest nutritional standards for African and international markets.",
      es: "AzaRatti está especializada en la venta y distribución de arroz natural de la mejor calidad. Un producto auténtico, cultivado con esmero y seleccionado según los más altos estándares nutricionales para los mercados africanos e internacionales.",
      de: "AzaRatti ist auf den Verkauf und Vertrieb von Natureis höchster Qualität spezialisiert. Ein authentisches Produkt, sorgfältig angebaut und nach höchsten Ernährungsstandards für afrikanische und internationale Märkte ausgewählt.",
      zh: "AzaRatti专注于销售和分销最优质的天然大米。这是一种真实的产品，经过精心种植，并按照最高营养标准为非洲和国际市场精选。",
    },
  },
];
